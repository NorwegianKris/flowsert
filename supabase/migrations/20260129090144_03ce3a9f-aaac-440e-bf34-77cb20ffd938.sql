-- Add debug logging to handle_new_user to diagnose signup failures
-- This will help us see exactly what metadata is being received
...
BEGIN
  ...
  IF _invite_token IS NOT NULL AND _invite_token != '' THEN
    ...
    RAISE LOG 'handle_new_user: found invitation by token=%', (_invitation IS NOT NULL);
  END IF;
  ...
  IF _invitation IS NULL THEN
    ...
    RAISE LOG 'handle_new_user: found invitation by email=%', (_invitation IS NOT NULL);
  END IF;
