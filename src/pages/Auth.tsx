...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-300 via-slate-200 to-slate-400 px-4 relative overflow-hidden">
