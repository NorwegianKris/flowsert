...
interface PersonnelInvitationsProps {
  personnelId: string;
}

export function PersonnelInvitations({ personnelId }: PersonnelInvitationsProps) {
  const { invitations, updateInvitationStatus, loading } = useProjectInvitations();
      ...
      <Dialog open={!!selectedInvitation} onOpenChange={(open) => !open && setSelectedInvitation(null)}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Invitation details for this project
            </DialogDescription>
          </DialogHeader>
