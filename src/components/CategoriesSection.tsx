            ...
            <Tabs defaultValue="roles" className="w-full">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 bg-primary rounded-md px-3 py-1.5">
                  ...
                  <span className="text-xs text-primary-foreground">Roles define job categories; Worker Groups organize personnel into custom teams.</span>
                </div>
              </div>
          ...
          <TabsContent value="certificates">
            ...
            <Tabs defaultValue={defaultSubTab || "categories"} className="w-full">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 bg-primary rounded-md px-3 py-1.5">
                  <span className="text-sm">💡</span>
                  <span className="text-xs text-primary-foreground">Categories are broad groupings; Types are specific classifications.</span>
                </div>
              </div>
